			...
			_loc_what.on('click',function(evt) {
                ...
                var _open_close = function(_a_target) {
                    ...
                    var _set_det = function(_a_elem) {
                        if ( _a_elem.attr('aria-expanded') == 'true') {
                            _a_elem.find('.ex_det_con').attr('style','min-height: 0px; height: 0px; transition-duration: 0ms;');
                        } else {
                            _a_elem.find('.ex_det_con').attr('style','min-height: 0px; height: '+_a_elem.find('.ex_det_con > div').height()+'px; transition-duration: 0ms;');
                        }
                    }
