...
$config['template.theme_paths'] = array('application/themes'); // modified for public folder
...
$config['assets.css_combine'] = true;
$config['assets.js_combine']  = true;
