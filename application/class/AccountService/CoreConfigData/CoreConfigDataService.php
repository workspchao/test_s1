...
class CoreConfigDataService extends BaseService {
    ...
    public static function build() {
        if (self::$_instance == NULL) {
            $_ci = &get_instance();
            $_ci->load->model('coreconfigdata/Core_config_data_model');
            self::$_instance = new CoreConfigDataService($_ci->Core_config_data_model);
        }
