...
class QrcodeHelper
{
    ...
    protected $_file_name       = 'qrcode';         // 写入文件路径
    protected $_file_path       = './public/images/user_qrcode';    // 写入文件路径
    ...
    public function __construct($config) {
        ...
        isset($config['file_path'])     &&  $this->_file_path       = $config['file_path'];
    }
    ...
    public function createQrcode($content) {
        ...
        if ($this->_generate == 'display') {
            ...
            return $this->generateImg($file_path, $file_name);
        } else {
     ...
     * @return array
     */
    public function generateImg($file_path, $file_name) {
        ...
        try {
            ...
            $file_path = $file_path.DIRECTORY_SEPARATOR.$file_name. '.' . self::WRITE_NAME;
